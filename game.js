...
function createKeyboard() {
    // Merge letters A-Z and numbers 1-4 into 10×3 grid (30 keys total)
...
function gameWon() {
    ...
    gameOverContent.innerHTML = `
        ...
        <p style="font-size: 1.5rem; margin: 20px 0; color: #333;">You completed all ${gameState.maxLevels} levels!</p>
...
function gameLost() {
    ...
    gameOverContent.innerHTML = `
        ...
        <p style="font-size: 1.3rem; margin: 20px 0; color: #333;">The phrase was:</p>
        <div class="revealed-phrase">${gameState.currentPhrase}</div>
        <p style="font-size: 1.2rem; margin: 20px 0; color: #666;">You reached level ${gameState.currentLevel}</p>
        <div class="final-score">Final Score: <span style="color: #FFD700;">${gameState.score}</span></div>
        <div class="gameover-buttons">
            <button class="gameover-btn primary" onclick="startGame()">
                <span>🔄</span> Try Again
